...
const DATA_CONFIG = JSON.stringify({
  ...
  EXPLORER,
  ASSET_SERVER_URL,
  ADALITE_DEFAULT_ADDRESS_COUNT: parseInt(ADALITE_DEFAULT_ADDRESS_COUNT || '10', 10),
  ADALITE_GAP_LIMIT: parseInt(ADALITE_GAP_LIMIT || '20', 10),
  ADALITE_DEMO_WALLET_MNEMONIC,
  ADALITE_ENABLE_DEBUGGING: ADALITE_ENABLE_DEBUGGING === 'true',
  ADALITE_APP_VERSION: APP_VERSION,
  ADALITE_LOGOUT_AFTER,
  ADALITE_TREZOR_CONNECT_URL,
  ADALITE_BACKEND_TOKEN,
  ADALITE_FIXED_DONATION_VALUE,
  ...
  return {
    ...
    transformIndexHtml(html) {
      return html
        ...
        .replace(/TREZOR_CONNECT_URL/g, process.env.ADALITE_TREZOR_CONNECT_URL)
